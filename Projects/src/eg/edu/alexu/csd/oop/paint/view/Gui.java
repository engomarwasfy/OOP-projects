...
public class Gui extends JFrame {
    /**
     * this is for indicating which button is on
     */
    public static String activeButton;
    /**
     * like activebutton but for editing
     */
	...
	tool2.setOrientation(SwingConstants.VERTICAL);
	getContentPane().add(tool2, BorderLayout.EAST);
	...
	JMenuItem chooseClassFile = new JMenuItem("Choose .class file");
	chooseClassFile.addActionListener(new ActionListener() {
	    public void actionPerformed(final ActionEvent e) {
	...
	mnAddextension.add(chooseClassFile);
