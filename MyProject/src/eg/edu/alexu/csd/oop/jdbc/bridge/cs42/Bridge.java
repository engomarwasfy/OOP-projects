...
import eg.edu.alexu.csd.oop.jdbc.engine.cs42.DataBase;
import eg.edu.alexu.csd.oop.jdbc.engine.cs42.DropDateBase;
import eg.edu.alexu.csd.oop.jdbc.engine.cs42.Table;
import eg.edu.alexu.csd.oop.jdbc.engine.cs42.XmlParsingMethods;
...
public class Bridge {
    ...
    private int[] getRows(String databaseName,String tableName , final String condition , String[] sql) throws SQLException {
	ArrayList<Integer> selectThisRow1 = condParse.parseCondition(databaseName , tableName , extractor.getCondition(sql));
    ...
    public int[] dirct(final Director dir, final String[] sql,String protocol)throws TransformerException, SAXException, IOException, ParserConfigurationException, SQLException {
    ...
    public String[][] dirct2(final Director dir, final String[] sql,String protocol)throws TransformerException, SAXException, IOException, ParserConfigurationException, SQLException {
	extractor = dir.getExtractor();
	String tableName = extractor.getTableName(sql);
	String dbName = extractor.getDataBaseName(sql);
	Table table = null;
