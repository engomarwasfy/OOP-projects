...
public AllShape getShape(String url,float x1 ,float y1 ,float x2,float y2 , Color fillColor ,Color drawColor ) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
