		...
		if (topMid.contains(place)) {
			for(AllShape s : moreshape) {
				if((s.getShapeName() == "circle") || (s.getShapeName() == "square")) {
					s.setBounds( Math.min(s.getX1(),s.getX2()) + dy , Math.min(s.getY1(),s.getY2()) + dy ,  Math.max(s.getX1(),s.getX2()) ,Math.max(s.getY1(),s.getY2()));
				} else {
					s.setBounds( Math.min(s.getX1(),s.getX2()) , Math.min(s.getY1(),s.getY2()) + dy ,  Math.max(s.getX1(),s.getX2()) ,Math.max(s.getY1(),s.getY2()));
				}
			}
		} else if (midRight.contains(place)) {
			for(AllShape s : moreshape) {
				if((s.getShapeName() == "circle") || (s.getShapeName() == "square")) {
					s.setBounds( Math.min(s.getX1(),s.getX2()) , Math.min(s.getY1(),s.getY2()) ,  Math.max(s.getX1(),s.getX2()) + dx,Math.max(s.getY1(),s.getY2()) + dx);
				} else {
					s.setBounds( Math.min(s.getX1(),s.getX2()) , Math.min(s.getY1(),s.getY2()) ,  Math.max(s.getX1(),s.getX2()) + dx,Math.max(s.getY1(),s.getY2()));
				}
			}
		} else if (botomMid.contains(place)) {
			for(AllShape s : moreshape) {
				if((s.getShapeName() == "circle") || (s.getShapeName() == "square")) {
					s.setBounds( Math.min(s.getX1(),s.getX2()) , Math.min(s.getY1(),s.getY2())  ,  Math.max(s.getX1(),s.getX2()) + dy ,Math.max(s.getY1(),s.getY2()) + dy);
				} else {
					s.setBounds( Math.min(s.getX1(),s.getX2()) , Math.min(s.getY1(),s.getY2())  ,  Math.max(s.getX1(),s.getX2()) ,Math.max(s.getY1(),s.getY2()) + dy);
				}
			}
		} else if (midLeft.contains(place)) {
			for(AllShape s : moreshape) {
				if((s.getShapeName() == "circle") || (s.getShapeName() == "square")) {
					s.setBounds( Math.min(s.getX1(),s.getX2()) + dx , Math.min(s.getY1(),s.getY2()) + dx ,  Math.max(s.getX1(),s.getX2()) ,Math.max(s.getY1(),s.getY2()));
				} else {
					s.setBounds( Math.min(s.getX1(),s.getX2()) + dx , Math.min(s.getY1(),s.getY2()) ,  Math.max(s.getX1(),s.getX2()) ,Math.max(s.getY1(),s.getY2()));
				}
