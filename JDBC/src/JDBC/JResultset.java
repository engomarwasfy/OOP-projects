...
public class JResultset implements ResultSet {
  ...
  public JResultset(final String[][] list, final ArrayList<String> colNames, final String tableName, ArrayList<String> colTypes) {
	    this.arr = list;
  ...
  private String[] convertColToArray(ArrayList<String> list) {
  ...
  public int findColumn(final String columnLabel) throws SQLException {
    ...
    final SQLException ex = new SQLException("data access error , error at findColumn()");
    throw ex;
  }
  ...
  public int getInt(final int columnIndex) throws SQLException {
    if (arr == null || columnIndex < 1 || columnIndex > arr[cursor].length || cursor < 0 || cursor >= arr.length) {
      final SQLException ex = new SQLException("data access error , error at getInt(int colIndex)");
      throw ex;
    }
  ...
  public int getInt(final String columnLabel) throws SQLException {
    ...
    if (found == false || arr == null || cursor < 0 || cursor >= arr.length) {
      final SQLException ex = new SQLException("data access error , error at getInt(String colLable)");
      throw ex;
    }
  ...
  public Date getDate(final int columnIndex) throws SQLException {
    if (arr == null || columnIndex < 1 || columnIndex > arr[cursor].length || cursor < 0 || cursor >= arr.length) {
      final SQLException ex = new SQLException("data access error , error at getDate(final int columnIndex)");
      throw ex;
    }
    if (arr[cursor][columnIndex - 1] == null) {
      return null;
...
String []DateArray = (arr[cursor][colIndex - 1]).split("-");
  ...
  public String getString(final int columnIndex) throws SQLException {
    if (arr == null || columnIndex < 1 || columnIndex > arr[cursor].length || cursor < 0 || cursor >= arr.length) {
      final SQLException ex = new SQLException("data access error , error at getString(String columnIndex)");
      throw ex;
    }
    if (arr[cursor][columnIndex - 1] == null) {
      return null;
    }
    return (String) arr[cursor][columnIndex - 1];
  ...
  public String getString(final String columnLabel) throws SQLException {
    ...
    if (found == false || arr == null || cursor < 0 || cursor >= arr.length) {
      final SQLException ex = new SQLException("data access error , error at getString(String columnLabel)");
      throw ex;
    }
    if (arr[cursor][colIndex - 1] == null) {
      return null;
    }
    return (String) arr[cursor][colIndex - 1];
  ...
  public float getFloat(final int columnIndex) throws SQLException {
    if (arr == null || columnIndex < 1 || columnIndex > arr[cursor].length || cursor < 0 || cursor >= arr.length) {
      final SQLException ex = new SQLException("data access error , error at getFloat(String columnIndex)");
      throw ex;
    }
    if (arr[cursor][columnIndex - 1] == null) {
      return 0;
  ...
  public float getFloat(final String columnLabel) throws SQLException {
    ...
    if (found == false || arr == null || cursor < 0 || cursor >= arr.length) {
      final SQLException ex = new SQLException("data access error , error at getFloat(final String columnLabel)");
      throw ex;
    }
    if (arr[cursor][colIndex - 1] == null) {
      return 0;
  ...
  public ResultSetMetaData getMetaData() throws SQLException {
	  return new JResultSetMetaData(colNames, arr, tableName);
  }
