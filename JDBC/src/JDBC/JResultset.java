...
public class JResultset implements ResultSet {
    ...
    public JResultset(final String[][] list, final ArrayList<String> colNames, final String tableName,
	...
	return (Date) new Date(Integer.parseInt(DateArray[0]), Integer.parseInt(DateArray[1]),
