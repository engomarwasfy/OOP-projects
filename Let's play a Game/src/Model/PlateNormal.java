...
public class PlateNormal extends GameObject{
  ...
  PlateNormal(final int x, final int y, final ID id, final ID direction,
      final ObjectsHandler handler, final String difficulty) {
    super(x, y, ID.Plate);
    factoryImage = new FactoryImage();
    image1 = factoryImage.getImage("plateblue.png");
    image2 = factoryImage.getImage("plategreen.png");
    image3 = factoryImage.getImage("platered.png");
    platesArr[0] = image1;
    platesArr[1] = image2;
    platesArr[2] = image3;
