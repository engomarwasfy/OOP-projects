...
public class treeGUI extends JFrame {
	...
	public AVLTreeImpl tree;
	public DrawTree drawer;
	
	/**
	 * Create the frame.
	 */
	public treeGUI(AVLTreeImpl tree) {
...
class DrawTree extends JPanel{
	...
	public DrawTree(AVLTreeImpl tree){
		this.tree = tree;
	}
	...
	protected void paintComponent(Graphics g) {
		...
		DrawTree(g, 0, getWidth(), 0, getHeight() / (tree.height()+1), tree.root);
	}
	
	public void DrawNode(Graphics g,NodeImp n,int w,int h,int q){
		g.setFont(new Font("Tahoma", Font.BOLD, 20));
    ...
    public void DrawTree(Graphics g, int StartWidth, int EndWidth, int StartHeight, int Level, NodeImp node) {
